    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="img/ccm.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">CCM AR</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Mtumiaji</a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                      ...
                      with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="page/changamotoManage.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Changamoto</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper iframe-mode" data-widget="iframe" data-loading-screen="750">
            ...
            <div class="tab-content">
                ...
                <div class="tab-empty">
                    <h2 class="display-6">Karibu Kwenye Mfumo wa Chama!</h2>
                </div>
