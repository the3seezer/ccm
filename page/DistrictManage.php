              ...
              <div class="card-header">
			   ...
			   <div class="col-10">
			    ...
			    <div class="pull-right col-2">
		          ...
		          <button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#modal-defaulttts">
...
<script>
 ...
 <div class="modal fade" id="modal-defaulttts">
     ...
     <label class="control-label col-md-12">District Name<span class="required">*</span></label>
     <div class="col-md-12">
     <input id="disName" class="form-control col-md-12"  name="disName"  required type="text">
     </select>
     </div>
     </div>
     ...
     <div class="col-md-12">
     <select id="gender" class="form-control col-md-12" name="region" required="required">
