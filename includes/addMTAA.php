...
<form  action="../includes/process.php" method="post"  class="form-horizontal form-label-left">
     ...
     <div class="item form-group">
     <label class="control-label col-md-3 col-sm-3 col-xs-12">Jina la Mtaa/Kijiji<span class="required">*</span></label>
     <div class="col-md-6 col-sm-6 col-xs-12">
     ...
     <input type="submit"  id="send"  class="btn btn-success" name="addMTAA" value="Submit"/>
